...
<link href="https://fonts.googleapis.com/css2?family=Maven+Pro:wght@500&family=Poppins:wght@300&display=swap" rel="stylesheet">
    <title>Alterar itens de serviço</title>
</head>
<body>
    <?php
...
$val = $_POST['valor'];
    ?>
    <h1>Editar Itens de Serviço</h1>
    <form action="AlteraItensServico.php" method="post">
        <fieldset>
        <input type="hidden" id="codigoids" name="codigoids" value="<?= $cids?>">
    ...
    <label action="valor" method="post"> Valor </label>
        <input type="number" id="valor" name="valor" value="<?= $val?>">
        </fieldset>
