...
$nom = $_POST['nome'];
    ...
    <form action="AlteraSubGrupo.php" method="post">
        <fieldset>
    <input type="hidden" id="codigosg" name="codigosg" value="<?= $csg?>">
    <label action="nome" method="post"> Grupo </label>
    <input type="text" id="codigogp" name="codigogp" value="<?= $cgp?>">
