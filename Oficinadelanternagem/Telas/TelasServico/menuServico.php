...
<body>
    ...
    <a href="http://localhost/Oficinadelanternagem/Telas/TelasServico/FormNovoServico.php"><button><i class="fas fa-plus button-icon"></i> Cadastrar Servico</button></a>
