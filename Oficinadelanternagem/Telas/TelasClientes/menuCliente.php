...
<body>
    ...
    <a href="/Oficinadelanternagem/Telas/TelasClientes/ListaCliente.php"><button><i class="fas fa-list button-icon"></i> Listar Clientes</button></a>
